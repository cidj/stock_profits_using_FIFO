...
def stock_FIFO(inputFile,outputFile):
    ...
    for l1 in np.unique(records2.index.get_level_values('Trader')):
        ...
        #Benefits of every trader are saved into a dictionary. The total 
        #transaction fees are deducted from them.
    ...
    totalBenefit.to_csv(outputFile,sep='\t',float_format = '%.2f')
    print(totalBenefit)